        ...
        <div className="relative overflow-hidden rounded-[48px] bg-[#072ac8] p-8 text-white shadow-2xl md:p-16 lg:p-20">
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            <h2 className="max-w-3xl font-[Georgia,serif] text-3xl font-bold leading-tight sm:text-4xl lg:text-5xl">
              Punya Dokumentasi Kegiatan <span className="text-[#FFC400]">Desa?</span>
            </h2>
            ...
            <button className="mt-10 h-16 rounded-full bg-[#000418] px-10 text-[15px] font-bold text-white shadow-xl transition-all hover:-translate-y-1 hover:shadow-2xl">
              Kirim Dokumentasi
            </button>
          </div>
        </div>
