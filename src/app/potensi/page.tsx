  ...
  return (
    <main className="min-h-screen bg-[#F6F6F8]">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-24 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[48px] bg-[#000418] p-8 text-white shadow-2xl md:p-16 lg:p-20">
          <div className="pointer-events-none absolute -right-24 -top-24 h-96 w-96 rounded-full bg-[#072ac8]/10 blur-[100px]" />
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            <h2 className="max-w-3xl font-[Georgia,serif] text-3xl font-bold leading-tight sm:text-4xl lg:text-5xl">
              Tertarik Berkolaborasi Mengembangkan <span className="text-[#FFC400]">Potensi Desa?</span>
            </h2>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              <button className="h-16 rounded-full bg-[#072ac8] px-10 text-[15px] font-bold text-white shadow-xl transition-all hover:-translate-y-1 hover:bg-[#0021B3]">
                Hubungi Kami
              </button>
