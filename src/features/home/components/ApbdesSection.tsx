  ...
  return (
    <section className="bg-white px-6 py-8 md:px-10 md:py-12 lg:px-12">
      <div className="mx-auto w-full max-w-7xl">
        ...
        <div className="hero-reveal group/apbdes relative overflow-visible rounded-[40px] bg-[#072ac8] p-6 text-[#FFFFFF] shadow-2xl transition-all duration-500 md:p-10 lg:p-14">
          {/* Background Elements */}
          ...
          <div className="relative z-30 mb-8 flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
            ...
            <div ref={yearDropdownRef} className="hero-reveal relative">
              ...
              <div className={`absolute right-0 top-[calc(100%+12px)] z-60 w-56 origin-top-right rounded-3xl border border-white/10 bg-[#072ac8]/95 p-3 shadow-2xl backdrop-blur-xl transition-all duration-500 ${isYearDropdownOpen ? "opacity-100 scale-100 translate-y-0" : "opacity-0 scale-95 -translate-y-4 pointer-events-none"}`}>
                <div className="grid gap-1">
                  {apbdesYears.map((year) => (
                    <button
                      ...
                      className={`flex w-full items-center justify-between rounded-xl px-4 py-3 text-left text-[14px] font-bold transition-all ${selectedYear === year ? "bg-[#1e96fc] text-[#072ac8]" : "text-white/60 hover:bg-white/5 hover:text-white"}`}
                    >
          ...
          <div className="relative z-10 grid gap-8 lg:grid-cols-[1fr_340px] lg:items-center">
            ...
            <div className="flex flex-col items-center gap-8 text-center lg:items-start lg:text-left">
              <p className="hero-reveal text-[15px] leading-relaxed text-[#a2d6f9]/70 md:text-[16px]">
