    ...
    <section className="bg-white px-6 py-8 md:px-10 md:py-12 lg:px-12">
      <div className="mx-auto w-full max-w-7xl">
        ...
        <div className="hero-reveal relative overflow-hidden rounded-[40px] bg-[#072ac8] px-6 py-8 text-[#FFFFFF] shadow-2xl transition-all duration-500 md:px-10 md:py-10 lg:rounded-[60px] lg:px-16 lg:py-0">
          {/* Decorative Elements */}
          <div className="absolute top-0 right-0 h-64 w-64 -translate-y-1/2 translate-x-1/2 rounded-full bg-[#ffc600]/10 blur-[80px]" />
          ...
          <div className="relative z-10 grid items-center gap-8 lg:grid-cols-[1fr_420px] lg:gap-16">
            <div className="hero-reveal flex flex-col items-center text-center lg:items-start lg:py-20 lg:text-left">
              <div className="inline-flex items-center gap-2 rounded-full bg-[#ffc600]/10 px-4 py-1.5 border border-[#1e96fc]/20">
              ...
              <div className="relative mt-8 max-w-xl">
                <Quote size={32} className="absolute -left-6 -top-6 opacity-10 text-[#ffc600] hidden lg:block" />
                <p className="text-[15px] leading-relaxed text-[#d0e7ff]/70 md:text-[17px]">
              ...
              <Link
                href="/profil"
                className="group mt-8 inline-flex items-center gap-3 rounded-2xl bg-[#FFC400] px-8 py-4 text-[15px] font-black text-[#072ac8] shadow-xl transition-all hover:-translate-y-1 hover:shadow-2xl active:scale-95"
              >
                Profil Lengkap
