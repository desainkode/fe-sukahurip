    ...
    <section className={sectionCardClass + " bg-[#ffffff]"}>
      <div className="flex flex-col gap-7">
        ...
        <div className="relative overflow-hidden rounded-[24px] bg-linear-to-br from-[#00082B] via-[#000C42] to-[#00051A] px-5 py-8 sm:rounded-[32px] sm:px-10 sm:py-14 md:px-12 md:py-16">
          ...
          <div className="relative z-10 grid items-stretch gap-8 xl:grid-cols-[1fr_minmax(280px,0.6fr)] xl:gap-16">
            ...
            <div className="flex flex-col items-center justify-center rounded-[24px] border border-white/5 bg-white/2 p-6 shadow-3xl backdrop-blur-md sm:rounded-[28px] sm:p-8">
