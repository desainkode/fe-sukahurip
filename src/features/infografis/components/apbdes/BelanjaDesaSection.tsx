  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <div className="relative mt-4">
        <div className="no-scrollbar -mx-4 flex snap-x snap-mandatory gap-4 overflow-x-auto px-4 pb-6 pt-8 sm:-mx-6 sm:px-6 md:-mx-7 md:px-7 lg:mx-0 lg:grid lg:grid-cols-3 lg:snap-none lg:overflow-visible lg:px-0 lg:pb-0 lg:pt-0 lg:gap-8">
          ...
          <div className="hero-reveal relative z-10 w-[280px] shrink-0 snap-center lg:w-auto" style={{ animationDelay: '300ms' }}>
            <BelanjaCardPrimary />
          </div>

          {/* Card 2: Pemerintahan Desa */}
          <div className="hero-reveal relative z-10 w-[280px] shrink-0 snap-center lg:w-auto" style={{ animationDelay: '380ms' }}>
          ...
          <div className="hero-reveal relative z-10 w-[280px] shrink-0 snap-center lg:w-auto" style={{ animationDelay: '460ms' }}>
            <BelanjaCardSecondary
              title="Pembangunan"
              value="Rp. 400.000"
          ...
          <div className="hero-reveal relative z-10 w-[280px] shrink-0 snap-center lg:w-auto" style={{ animationDelay: '540ms' }}>
            <BelanjaCardSecondary
              title="Pembinaan"
              value="Rp. 100.000"
          ...
          <div className="hero-reveal relative z-10 w-[280px] shrink-0 snap-center lg:w-auto" style={{ animationDelay: '620ms' }}>
            <BelanjaCardSecondary
              title="Pemberdayaan"
              value="Rp. 100.000"
          ...
          <div className="hero-reveal relative z-10 w-[280px] shrink-0 snap-center lg:w-auto" style={{ animationDelay: '700ms' }}>
            <BelanjaCardSecondary
